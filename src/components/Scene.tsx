...
import { Float, Text3D, OrbitControls, Sphere, PerspectiveCamera, Stars, useAspect, Torus, TorusKnot, Octahedron, Icosahedron, MeshDistortMaterial } from '@react-three/drei';
